 ...
 */
@Generated
public class lptstore__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new lptstore__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new lptstore__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
